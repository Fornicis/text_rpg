...
def initialise_enemies():
    return {
            ...
            "Rat": Enemy("Rat", 21, 21, 5, 10, random.randrange(3, 10), "low", 1, ["normal", "quick", "poison"]),
            ...
            "Goblin": Enemy("Goblin", 27, 25, 8, 15, random.randrange(5, 15), "low", 2, ["normal", "quick", "poison"]),
            "Spider": Enemy("Spider", 22, 26, 5, 20, random.randrange(8, 18), "low", 1, ["normal", "quick", "poison"]),
            ...
            "Giant Firefly": Enemy("Giant Firefly", 34, 24, 8, 25, random.randrange(10, 20), "low", 2, ["normal", "quick", "poison"]),
            ...
            "Poison Frog": Enemy("Poison Frog", 60, 45, 28, 40, random.randrange(35, 46), "medium", 4, ["normal", "quick", "poison"]),
            "Swamp Troll": Enemy("Swamp Troll", 89, 44, 32, 45, random.randrange(40, 51), "medium", 6, ["normal", "power", "poison"]),
            "Mosquito Swarm": Enemy("Mosquito Swarm", 64, 47, 26, 35, random.randrange(30, 41), "medium", 4, ["normal", "quick", "poison"]),
            ...
            "Desert Bandit": Enemy("Desert Bandit", 77, 47, 30, 50, random.randrange(45, 56), "medium", 5, ["normal", "quick", "poison"]),
            ...
            "Mirage Assassin": Enemy("Mirage Assassin", 170, 86, 80, 110, random.randrange(180, 201), "hard", 17, ["normal", "quick", "poison"]),
