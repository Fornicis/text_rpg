...
def initialise_enemies():
    return {
            ...
            "Alligator": Enemy("Alligator", 98, 28, 17, 35, random.randrange(30, 41), "medium", 5),
            "Poison Frog": Enemy("Poison Frog", 75, 32, 9, 40, random.randrange(35, 46), "medium", 4),
            "Swamp Troll": Enemy("Swamp Troll", 115, 23, 21, 45, random.randrange(40, 51), "medium", 6),
            "Mosquito Swarm": Enemy("Mosquito Swarm", 81, 26, 12, 35, random.randrange(30, 41), "medium", 4),
            "Bog Witch": Enemy("Bog Witch", 92, 30, 14, 50, random.randrange(45, 56), "medium", 5),
            
            "Stone Golem": Enemy("Stone Golem", 132, 25, 25, 55, random.randrange(50, 61), "medium", 6),
            "Cultist": Enemy("Cultist", 86, 29, 15, 40, random.randrange(35, 46), "medium", 4),
            "Mummy": Enemy("Mummy", 98, 28, 17, 45, random.randrange(40, 51), "medium", 5),
            "Animated Statue": Enemy("Animated Statue", 109, 26, 21, 50, random.randrange(45, 56), "medium", 5),
            "Temple Guardian": Enemy("Temple Guardian", 121, 30, 20, 55, random.randrange(50, 61), "medium", 6),
            
            "Mountain Lion": Enemy("Mountain Lion", 92, 31, 14, 40, random.randrange(35, 46), "medium", 4),
            "Rock Elemental": Enemy("Rock Elemental", 127, 24, 25, 50, random.randrange(45, 56), "medium", 6),
            "Harpy": Enemy("Harpy", 86, 33, 13, 45, random.randrange(40, 51), "medium", 4),
            "Yeti": Enemy("Yeti", 115, 29, 17, 50, random.randrange(45, 56), "medium", 6),
            "Orc": Enemy("Orc", 104, 28, 15, 40, random.randrange(35, 46), "medium", 5),
            
            "Sand Wurm": Enemy("Sand Wurm", 121, 30, 17, 45, random.randrange(40, 51), "medium", 6),
            "Dried Mummy": Enemy("Dried Mummy", 109, 26, 20, 40, random.randrange(35, 46), "medium", 5),
            "Dust Devil": Enemy("Dust Devil", 81, 35, 14, 45, random.randrange(40, 51), "medium", 4),
            "Desert Bandit": Enemy("Desert Bandit", 98, 30, 15, 50, random.randrange(45, 56), "medium", 5),
            "Leopard": Enemy("Leopard", 86, 32, 12, 35, random.randrange(30, 41), "medium", 3),
