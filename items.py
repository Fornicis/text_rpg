...
def initialise_items():
    return {
        ...
        "Bronze Axe": Item("Bronze Axe", "weapon", 35, "common", attack=8, weapon_type="light"),
        "Bronze Longsword": Item("Bronze Longsword", "weapon", 40, "common", attack=7, weapon_type="medium"),
        "Bronze Mace": Item("Bronze Mace", "weapon", 45, "common", attack=8, weapon_type="medium"),
        "Bronze Spear": Item("Bronze Spear", "weapon", 50, "common", attack=9, weapon_type="medium"),
        "Bronze Hammer": Item("Bronze Hammer", "weapon", 55, "common", attack=10, weapon_type="medium"),
        "Bronze Flail": Item("Bronze Flail", "weapon", 60, "common", attack=9, weapon_type="heavy"),
        "Bronze Warhammer": Item("Bronze Warhammer", "weapon", 65, "common", attack=10, weapon_type="heavy"),
        ...
        "Iron Axe": Item("Iron Axe", "weapon", 110, "uncommon", attack=18, weapon_type="light"),
        "Iron Longsword": Item("Iron Longsword", "weapon", 120, "uncommon", attack=17, weapon_type="medium"),
        "Iron Mace": Item("Iron Mace", "weapon", 130, "uncommon", attack=19, weapon_type="medium"),
        "Iron Spear": Item("Iron Spear", "weapon", 140, "uncommon", attack=21, weapon_type="medium"),
        "Iron Hammer": Item("Iron Hammer", "weapon", 150, "uncommon", attack=22, weapon_type="medium"),
        "Iron Flail": Item("Iron Flail", "weapon", 160, "uncommon", attack=20, weapon_type="heavy"),
        "Iron Warhammer": Item("Iron Warhammer", "weapon", 170, "uncommon", attack=22, weapon_type="heavy"),
        ...
        "Steel Axe": Item("Steel Axe", "weapon", 260, "rare", attack=31, weapon_type="light"),
        "Steel Longsword": Item("Steel Longsword", "weapon", 280, "rare", attack=30, weapon_type="medium"),
        "Steel Mace": Item("Steel Mace", "weapon", 300, "rare", attack=33, weapon_type="medium"),
        "Steel Spear": Item("Steel Spear", "weapon", 320, "rare", attack=36, weapon_type="medium"),
        "Steel Hammer": Item("Steel Hammer", "weapon", 340, "rare", attack=38, weapon_type="medium"),
        "Steel Flail": Item("Steel Flail", "weapon", 360, "rare", attack=35, weapon_type="heavy"),
        "Steel Warhammer": Item("Steel Warhammer", "weapon", 380, "rare", attack=38, weapon_type="heavy"),
        ...
        "Mithril Axe": Item("Mithril Axe", "weapon", 650, "epic", attack=55, weapon_type="light"),
        "Mithril Longsword": Item("Mithril Longsword", "weapon", 700, "epic", attack=53, weapon_type="medium"),
        "Mithril Mace": Item("Mithril Mace", "weapon", 750, "epic", attack=58, weapon_type="medium"),
        "Mithril Spear": Item("Mithril Spear", "weapon", 800, "epic", attack=63, weapon_type="medium"),
        "Mithril Hammer": Item("Mithril Hammer", "weapon", 850, "epic", attack=65, weapon_type="medium"),
        "Mithril Flail": Item("Mithril Flail", "weapon", 900, "epic", attack=60, weapon_type="heavy"),
        "Mithril Warhammer": Item("Mithril Warhammer", "weapon", 950, "epic", attack=65, weapon_type="heavy"),
        ...
        "Adamantite Axe": Item("Adamantite Axe", "weapon", 2600, "legendary", attack=95, weapon_type="light"),
        "Adamantite Longsword": Item("Adamantite Longsword", "weapon", 2800, "legendary", attack=93, weapon_type="medium"),
        "Adamantite Mace": Item("Adamantite Mace", "weapon", 3000, "legendary", attack=100, weapon_type="medium"),
        "Adamantite Spear": Item("Adamantite Spear", "weapon", 3200, "legendary", attack=105, weapon_type="medium"),
        "Adamantite Hammer": Item("Adamantite Hammer", "weapon", 3400, "legendary", attack=108, weapon_type="medium"),
        "Adamantite Flail": Item("Adamantite Flail", "weapon", 3600, "legendary", attack=103, weapon_type="heavy"),
        "Adamantite Warhammer": Item("Adamantite Warhammer", "weapon", 3800, "legendary", attack=110, weapon_type="heavy"),
        ...
        "Fang of the Cosmos": Item("Fang of the Cosmos", "weapon", 5250, "mythical", attack=126, weapon_type="light"),
        "Oblivion's Embrace": Item("Oblivion's Embrace", "weapon", 5300, "mythical", attack=127, weapon_type="heavy"),
        "Harmony's Discord": Item("Harmony's Discord", "weapon", 5350, "mythical", attack=128, weapon_type="medium"),
        "Eternity's Edge": Item("Eternity's Edge", "weapon", 5400, "mythical", attack=130, weapon_type="light"),
        "Apocalypse Incarnate": Item("Apocalypse Incarnate", "weapon", 5450, "mythical", attack=131, weapon_type="heavy"),
        "Starforged Annihilator": Item("Starforged Annihilator", "weapon", 5500, "mythical", attack=132, weapon_type="medium"),
        ...
        "Adamantite Crown": Item("Adamantite Crown", "helm", 1100, "legendary", defence=13),
        "Adamantite Diadem": Item("Adamantite Diadem", "helm", 1150, "legendary", defence=14),
        "Crown of Infinite Wisdom": Item("Crown of Infinite Wisdom", "helm", 5200, "mythical", defence=18),
        "Diadem of Omniscient Thought": Item("Diadem of Omniscient Thought", "helm", 5250, "mythical", defence=19),
        ...
        "Steel Breastplate": Item("Steel Breastplate", "chest", 120, "rare", defence=9),
        "Steel Hauberk": Item("Steel Hauberk", "chest", 125, "rare", defence=10),
        "Mithril Plate Armour": Item("Mithril Plate Armour", "chest", 350, "epic", defence=13),
        "Mithril Cuirass": Item("Mithril Cuirass", "chest", 360, "epic", defence=14),
        "Adamantite Godplate": Item("Adamantite Godplate", "chest", 1300, "legendary", defence=18),
        "Adamantite Vanguard": Item("Adamantite Vanguard", "chest", 1350, "legendary", defence=19),
        "Vestment of Universal Constants": Item("Vestment of Universal Constants", "chest", 5500, "mythical", defence=24),
        "Cuirass of the Unbreakable Will": Item("Cuirass of the Unbreakable Will", "chest", 5600, "mythical", defence=25),
        ...
        "Iron Cuisses": Item("Iron Cuisses", "legs", 48, "uncommon", defence=5),
        "Steel Cuisses": Item("Steel Cuisses", "legs", 110, "rare", defence=7),
        "Steel Tassets": Item("Steel Tassets", "legs", 115, "rare", defence=8),
        "Mithril Leggings": Item("Mithril Leggings", "legs", 330, "epic", defence=11),
        "Mithril Cuisses": Item("Mithril Cuisses", "legs", 340, "epic", defence=12),
        "Adamantite Legguards": Item("Adamantite Legguards", "legs", 1280, "legendary", defence=16),
        "Adamantite Cuisses": Item("Adamantite Cuisses", "legs", 1300, "legendary", defence=17),
        "Leggings of Cosmic Balance": Item("Leggings of Cosmic Balance", "legs", 5350, "mythical", defence=22),
        "Tassets of Reality's Anchor": Item("Tassets of Reality's Anchor", "legs", 5400, "mythical", defence=23),
        ...
        "Steel Sabatons": Item("Steel Sabatons", "boots", 75, "rare", defence=4),
        ...
        "Adamantite Striders": Item("Adamantite Striders", "boots", 1200, "legendary", defence=10),
        "Adamantite Treads": Item("Adamantite Treads", "boots", 1220, "legendary", defence=11),
        "Boots of Boundless Journey": Item("Boots of Boundless Journey", "boots", 5300, "mythical", defence=15),
        "Sabatons of the Astral Strider": Item("Sabatons of the Astral Strider", "boots", 5350, "mythical", defence=16),
        ...
        "Adamantite Fists": Item("Adamantite Fists", "gloves", 1150, "legendary", defence=9),
        "Adamantite Crushers": Item("Adamantite Crushers", "gloves", 1180, "legendary", defence=10),
        "Gauntlets of Primordial Might": Item("Gauntlets of Primordial Might", "gloves", 5100, "mythical", defence=14),
        "Vambraces of Cosmic Manipulation": Item("Vambraces of Cosmic Manipulation", "gloves", 5150, "mythical", defence=15),
        ...
        "Mithril Tower Shield": Item("Mithril Tower Shield", "shield", 220, "epic", defence=10),
        "Mithril Aegis": Item("Mithril Aegis", "shield", 230, "epic", defence=11),
        "Adamantite Bulwark": Item("Adamantite Bulwark", "shield", 950, "legendary", defence=14),
        "Adamantite Aegis": Item("Adamantite Aegis", "shield", 980, "legendary", defence=15),
        "Aegis of the Cosmos": Item("Aegis of the Cosmos", "shield", 4800, "mythical", defence=20),
        "Bulwark of Eternal Defiance": Item("Bulwark of Eternal Defiance", "shield", 4900, "mythical", defence=21),

        # Back
        "Leather Poncho": Item("Leather Poncho", "back", 13, "common", defence=1),
        "Leather Cloak": Item("Leather Cloak", "back", 14, "common", defence=2),
        "Bronze-Weave Mantle": Item("Bronze-Weave Mantle", "back", 43, "uncommon", defence=3),
        "Iron-Trimmed Cloak": Item("Iron-Trimmed Cloak", "back", 45, "uncommon", defence=4),
        ...
        "Adamantite Shadowcloak": Item("Adamantite Shadowcloak", "back", 1250, "legendary", defence=12),
        "Adamantite Veil": Item("Adamantite Veil", "back", 1270, "legendary", defence=13),
        "Cloak of Celestial Shadows": Item("Cloak of Celestial Shadows", "back", 5400, "mythical", defence=17),
        "Mantle of Ethereal Whispers": Item("Mantle of Ethereal Whispers", "back", 5450, "mythical", defence=18),
        ...
        "Mithril Signet": Item("Mithril Signet", "ring", 410, "epic", attack=4, defence=4),
